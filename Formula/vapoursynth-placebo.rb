class VapoursynthPlacebo < Formula
  ...
  test do
    ...
    if OS.linux?
      # This is the only safe test because some Akarin features require Vulkan support,
      # and Vulkan support on CI is very spotty.
      system python, "-c", "from vapoursynth import core; core.akarin"
    else
      if OS.mac? && MacOS.version <= :sequoia
        # https://github.com/KhronosGroup/MoltenVK/issues/2373
